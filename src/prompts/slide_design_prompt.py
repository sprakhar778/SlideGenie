...
1. FIXED CONTAINER (.slide required):
   ...
   width:1380px; height:700px; padding:30px;padding-bottom-40px box-sizing:border-box; overflow:hidden; position:relative; break-inside:avoid; page-break-inside:avoid ;
...
DON’TS:
No webpage aesthetic. No external CSS/JS. No animations. No personal info unless provided. No overflow beyond 1380×700. Do not rely on object-fit without fixed wrapper. No width:100% without border-box. No vh/vw.
