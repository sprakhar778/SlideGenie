HERO_SLIDE_LAYOUT = {
  ...
  "3": {
    ...
    "structure": (
      ...
      "(1) Small uppercase category  — font-size:11px; letter-spacing:4px; opacity:0.5; margin-bottom:20px. "
      ...
      "(4) Subtitle  — font-size:18px; font-weight:300; opacity:0.65; letter-spacing:0.5px. "
  ...
  "8": {
    ...
    "structure": (
      ...
      "Top text block: "
      "(1) Eyebrow phase  — 11px uppercase, letter-spacing:2.5px, accent, pill shape. "
  ...
  "9": {
    ...
    "structure": (
      ...
      "  • Left: presentation subtopic or some contetnt — 12px uppercase, letter-spacing:3px, opacity:0.6. "
