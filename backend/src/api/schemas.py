...
class SlideCodeEditRequest(BaseModel):
    """Body for POST /presentation-slides/{presentation_id}/slide/{slide_index}/edit"""
    user_input: str = Field(..., description="The user's feedback or request to modify the slide code.")

    model_config = {
        "json_schema_extra": {
            "example": {
                "user_input": "Make the background darker and the text larger."
            }
        }
    }
